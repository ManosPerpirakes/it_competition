...
answers_db = {
    "Αν κάποιος δημοσιεύσει προσωπικά μου στοίχεια παρά τη θελήση μου\n (φωτογραφικό υλικό ή γραπτό μύνημα) πώς πρέπει να δράσω;": "Να ενημερώσω τους γονείς μου άμεσα",
    "Κάποιος γνωστός μου, μου στέλνει προσωπικά στοιχεία όπως τηλέφωνο\n, pin καρτών, κτλ πώς αντιδρώ;": "του επισημαίνω να τα σβήσει και να τ' αλλάζει",
    "Υπάρχουν διάφοροι χρήστες που εκφράζουν την άποψή τους πάνω σε ένα\n θέμα που είτε συμφωνώ είτε διαφωνώ, τι κάνω;": "Εκφράζω την άποψή μου, με ευγένεια και επιχειρήματα"     
}
show_q()
a1 = False
a2 = False
